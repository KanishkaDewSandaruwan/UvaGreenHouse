...
<nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn " data-wow-delay="0.1s">
                    ...
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <h1 class="display-2 mb-5 text-white animated slideInDown"><?php echo $res['header_desc']; ?></h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
                ...
                <div class="col-lg-6 text-start text-lg-end wow slideInRight" data-wow-delay="0.1s">
                    ...
                    <?php 
                        ...
                        <li class="nav-item me-2">
                            <a class="btn btn-outline-primary border-2" data-bs-toggle="pill" href="#<?php echo $row['cat_name']; ?>"><?php echo $row['cat_name']; ?></a>
                        </li>
                        <?php } } ?>
                    </ul>
                </div>
            ...
            if ($row2 = mysqli_fetch_assoc($getallCp2)) {
                ?>
                <div id="<?php echo $row['cat_name']; ?>" class="tab-pane fade show p-0  <?php if($count < 2) {echo 'active'; } ?>">
                    <div class="row g-4">
                    <?php
                    $getallCp2 = getAllProductItemsByCategory($cat_id);
                    $count = 0;
                    while ($row3 = mysqli_fetch_assoc($getallCp2)) {
                        ...
                        <?php } $count++; } ?>
                        <div class="col-12 text-center wow fadeInUp" data-wow-delay="0.1s">
                            <a class="btn btn-primary rounded-pill py-3 px-5" href="product.php?cat_id=<?php echo $row['cat_id']; ?>">Browse More <?php echo $row['cat_name']; ?></a>
                        </div>
                    </div>
                </div>
                <?php } $count++; } ?>
        ...
        <div class="container">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-md-5 text-md-end wow fadeIn" data-wow-delay="0.5s">
                    <a class="btn btn-lg btn-secondary rounded-pill py-3 px-5" href="about.php">More Details</a>
                </div>
            </div>
        </div>
    </div>
